...
def _hlp():
    print("""Usage:
    qt5autostart -tui   = to execute the programs in the autostart directories;
    qt5autostart -gui   = execute the program in gui mode to manage the autoexec programs;
    qt5autostart --help = this help.""")
